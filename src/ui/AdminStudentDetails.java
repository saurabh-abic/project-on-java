...
public class AdminStudentDetails extends JInternalFrame {
	...
	public AdminStudentDetails() {
        ...
        btnBack.setBounds(325, 425, 89, 23);
        ...
        btnUpdate.addActionListener(new ActionListener() {
        	public void actionPerformed(ActionEvent e) {
        		String dept=textField_8.getText();
        		String roll=jt9.getText();
        	//	StudentDao u=StudentDao.getStudentDao();
            	AdminDao ad=new AdminDao();
            int i=	ad.studentUpdate(dept,roll);
        ...
        btnUpdate.setBounds(110, 425, 89, 23);
